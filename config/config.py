...
def init_test_mot17():
    #config['resume'] = './weights/SaveFolderv1.pth'
    config['resume'] = './weights/sst300_0712_83000.pth'
    config['mot_root'] = '/data1/usersdata/MOT/MOT17/'
    config['save_folder'] = '/data1/home/hhz/DAN/SaveFolder'
    config['log_folder'] = '/data1/home/hhz/DAN/LogFolder'
    config['batch_size'] = 1
    config['write_file'] = True
    config['tensorboard'] = True
    config['save_combine'] = False
    config['type'] = 'train' # can be 'test' or 'train'. 'test' represents 'test dataset'. while 'train\ represents 'train dataset'
...
def init_train_mot17():
    ...
    config['log_folder'] = '/data1/home/hhz/DAN/LogFolder'
    config['save_folder'] = '/data1/home/hhz/DAN/SaveFolder'
    config['save_images_folder'] = '/data1/home/hhz/DAN/SaveImagesFolder'
    config['type'] = 'train'
